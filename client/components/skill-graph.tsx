...
export function SkillGraph({ skills, projects }: { skills: Skill[]; projects: Project[] }) {
  ...
  if (!visibleProjects.length && !visibleSkills.length) return <div className="graph-empty"><span className="graph-center-static">CareerOS</span><p>Add skills and projects to build your evidence graph.</p></div>
  ...
  return <svg className="skill-graph" viewBox="0 0 520 300" role="img" aria-label="Projects connected to skills">
