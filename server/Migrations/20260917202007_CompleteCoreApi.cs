...
{
    /// <inheritdoc />
    public partial class CompleteCoreApi : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterviewAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Notes = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
                    JobDescription = table.Column<string>(type: "character varying(30000)", maxLength: 30000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_JobRequirements_Weight", "\"Weight\" BETWEEN 1 AND 5");
                    table.ForeignKey(
                        name: "FK_JobRequirements_JobApplications_JobApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobRequirements_JobApplicationId_Name",
                table: "JobRequirements",
                columns: new[] { "JobApplicationId", "Name" });
