...
export default async function LandingPage() {
  ...
  return (
    <main className="landing-page" style={{ isolation: "isolate", overflowY: "visible", paddingTop: "120px" }}>
      <AntigravityBackground />
      <header className="public-header" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50 }}><div className="public-header-shell" style={{ backgroundColor: "rgba(255, 255, 255, 0.7)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
        <Brand />
      ...
      <section className="landing-hero">
        <div className="hero-copy">
          ...
          <h1>Turn your skills and experience into real <ShinyText text="opportunities." color="#2a73ef" shineColor="#ffffff" speed={2.5} spread={120} /></h1>
      ...
      <section className="feature-strip" id="features">
        {features.map((feature) => (
          <Magnet key={feature.title} padding={60} magnetStrength={6} wrapperClassName="h-full">
            <article className="h-full"><span className="soft-icon"><Icon name={feature.icon} /></span><div><h2>{feature.title}</h2><p>{feature.text}</p></div></article>
          </Magnet>
        ))}
      </section>
