...
const features: Array<{ icon: IconName; title: string; text: string }> = [
  {
    ...
    text: "Keep skills, projects, and applications together.",
  },
  {
    icon: "chart",
    title: "Understand your fit",
    text: "Compare requirements with the skills you have.",
  },
  {
    icon: "sparkles",
    title: "Build real evidence",
    text: "Connect projects to the skills they demonstrate.",
  },
  {
    icon: "target",
    title: "Close the gaps",
    text: "Turn missing skills into focused next steps.",
  },
];
    ...
    <main className="landing-page">
      ...
      <section className="landing-hero">
        <div className="hero-copy">
          ...
          <p>
            ...
            understand what to improve next — all in one focused workspace.
          </p>
          <div className="hero-actions">
            ...
            >
              {authenticated ? "Open your dashboard" : "Get started for free"}
              <Icon name="arrow" />
            </Link>
          ...
          <ul className="hero-proof">
            ...
            <li>
              <Icon name="check" />
              Built around real job requirements
            </li>
          </ul>
        </div>
        <div className="hero-visual">
          ...
          <Image
            ...
            src="/images/careeros/mountain-night.png"
            fill
            priority
            sizes="(max-width: 900px) 100vw, 48vw"
          ...
          <div className="hero-preview-card">
            ...
            <div>
              <strong>Your career, clearly connected.</strong>
      ...
      <section className="landing-story" id="how-it-works">
        <div className="story-visual">
          ...
          <Image
            className="theme-image theme-image-dark"
            src="/images/careeros/journey-night.png"
            fill
            sizes="(max-width:800px) 100vw,48vw"
        ...
        <div className="story-copy" id="about">
          ...
          <h2>
            Career progress becomes useful when the evidence is connected.
          </h2>
          <p>
            CareerOS gives every skill context, every project a purpose and
            every application a clear place in your journey.
          </p>
          <ol>
            <li>
              <span>01</span>Build a practical skill profile
            </li>
            <li>
              <span>02</span>Connect skills to projects you actually built
            </li>
            <li>
              <span>03</span>Compare your evidence with real roles
            </li>
          </ol>
          <Link
            ...
            href={authenticated ? "/dashboard" : signup}
          >
            {authenticated ? "Continue building" : "Start building"}
            <Icon name="arrow" />
          </Link>
        </div>
      </section>
      ...
      <footer className="landing-footer">
        <Brand compact />
        <p>Build your tomorrow with deliberate steps.</p>
